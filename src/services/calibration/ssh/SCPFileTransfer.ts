 ...
 *
 * @module services/calibration/ssh/SCPFileTransfer
 */

import { getEnvironmentService } from '../../EnvironmentService';
import fs from 'fs/promises';
import path from 'path';
import type { TransferProgress, TransferResult } from '../../../types/calibration';
...
export class SCPFileTransfer {
  ...
  constructor(connectionManager: SSHConnectionManager) {
    ...
    this.cacheDir = path.join(getEnvironmentService().getDataPath(), 'calibration', 'cache');
  }
