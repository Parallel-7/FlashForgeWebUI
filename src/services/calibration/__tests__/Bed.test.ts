 ...
 *
 * @module services/calibration/__tests__/Bed.test
 */

import { describe, expect, it } from '@jest/globals';
import type { BedConfig, MeshData } from '../../../types/calibration';
import { BedCorner, DEFAULT_BED_CONFIG } from '../../../types/calibration';
...
describe('Bed', () => {
  ...
  describe('clone', () => {
    it('should create an independent copy', () => {
      ...
      // Modify cloned mesh
      if (!cloned.meshData) {
        throw new Error('Expected cloned mesh data');
      }
