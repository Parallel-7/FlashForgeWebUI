 ...
 *
 * @module services/calibration/engine/WorkflowEngine
 */
...
import { BedCorner, WorkflowStage } from '../../../types/calibration';
  ...
  private buildTemperatureStage(meshBefore: number[][]): { stage: WorkflowStageResult; meshAfter: number[][] } {
    ...
    return {
      stage: {
        key: 'after_temperature',
        label: 'Temperature Prediction',
        description: `Thermal expansion at ${activePreset.targetTemp}Â°C`,
        enabled: hasEffect,
        deviation,
        baseline,
        mesh: meshAfter,
