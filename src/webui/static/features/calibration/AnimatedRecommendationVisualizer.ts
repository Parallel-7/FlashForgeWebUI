/**
 * @fileoverview Animated visualization for screw adjustments and tape
 * recommendations (WebUI copy). Browser-pure port of the desktop
 * AnimatedRecommendationVisualizer: draws the bed outline with pulsing
 * rotation arrows per corner and tape-layer markers.
 */

import type { ScrewAdjustment, TapeRecommendation } from './types.js';
