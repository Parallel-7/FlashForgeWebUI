/**
 * @fileoverview Canvas visualization for input shaper frequency analysis (WebUI copy).
 * Browser-pure port of the desktop ShaperPlotVisualizer: renders power spectral
 * density plots with peak markers and the recommended shaper frequency.
 */

import type { AxisCalibration } from './types.js';
