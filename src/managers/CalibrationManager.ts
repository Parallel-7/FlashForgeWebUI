 ...
 *
 * @module managers/CalibrationManager
 */
...
import { DEFAULT_BED_CONFIG, DEFAULT_CALIBRATION_SETTINGS } from '../types/calibration';
...
export class CalibrationManager {
  ...
  private constructor() {
    ...
    this.dataPath = path.join(getEnvironmentService().getDataPath(), 'calibration');
  }
