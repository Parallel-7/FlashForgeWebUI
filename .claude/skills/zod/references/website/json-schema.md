...
## [`z.fromJSONSchema()`](?id=zfromjsonschema)
...
## [`z.toJSONSchema()`](?id=ztojsonschema)
...
### [Object schemas](?id=object-schemas)
...
Attaching and manipulatinvg metadata on Zod schemas](/metadata)[Codecs

Bidirectional transformations with encode and decode](/codecs)

### On this page

[`z.fromJSONSchema()`](#zfromjsonschema)[`z.toJSONSchema()`](#ztojsonschema)[`io`](#io)[`target`](#target)[`metadata`](#metadata)[`unrepresentable`](#unrepresentable)[`cycles`](#cycles)[`reused`](#reused)[`override`](#override)[Conversion](#conversion)[String formats](#string-formats)[Numeric types](#numeric-types)[Object schemas](#object-schemas)[File schemas](#file-schemas)[Nullability](#nullability)[Registries](#registries)