...
![Codecs encoding and decoding data across a network boundary](/codecs/codecs-network-light.svg)![Codecs encoding and decoding data across a network boundary](/codecs/codecs-network-dark.svg)
...
![Codec directionality diagram showing bidirectional transformation between input and output schemas](/_next/image?url=%2Fcodecs%2Fcodecs-light.png&w=1920&q=100)![Codec directionality diagram showing bidirectional transformation between input and output schemas](/_next/image?url=%2Fcodecs%2Fcodecs-dark.png&w=1920&q=100)
...
## [How encoding works](?id=how-encoding-works)
...
## [Useful codecs](?id=useful-codecs)
...
How to convert Zod schemas to JSON Schema](/json-schema)[Ecosystem

Overview of the Zod ecosystem including integrations, tools, and community resources](/ecosystem)

### On this page

[Composability](#composability)[Type-safe inputs](#type-safe-inputs)[Async and safe variants](#async-and-safe-variants)[How encoding works](#how-encoding-works)[Codecs](#codecs)[Pipes](#pipes)[Refinements](#refinements)[Defaults and prefaults](#defaults-and-prefaults)[Catch](#catch)[Stringbool](#stringbool)[Transforms](#transforms)[Useful codecs](#useful-codecs)[`stringToNumber`](#stringtonumber)[`stringToInt`](#stringtoint)[`stringToBigInt`](#stringtobigint)[`numberToBigInt`](#numbertobigint)[`isoDatetimeToDate`](#isodatetimetodate)[`epochSecondsToDate`](#epochsecondstodate)[`epochMillisToDate`](#epochmillistodate)[`json(schema)`](#jsonschema)[`utf8ToBytes`](#utf8tobytes)[`bytesToUtf8`](#bytestoutf8)[`base64ToBytes`](#base64tobytes)[`base64urlToBytes`](#base64urltobytes)[`hexToBytes`](#hextobytes)[`stringToURL`](#stringtourl)[`stringToHttpURL`](#stringtohttpurl)[`uriComponent`](#uricomponent)