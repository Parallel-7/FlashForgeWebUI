...
[Edit this page](https://github.com/colinhacks/zod/edit/main/packages/docs/content/v4/versioning.mdx)

### [**Update — July 8th, 2025**](?id=update--july-8th-2025)
...
## [Versioning in Zod 4](?id=versioning-in-zod-4)
...
### [Why can't libraries just support v3 and v4 simultaneously?](?id=why-cant-libraries-just-support-v3-and-v4-simultaneously)
...
[**Update — July 8th, 2025**](#update--july-8th-2025)[Versioning in Zod 4](#versioning-in-zod-4)[Why?](#why)[Why can't libraries just support v3 and v4 simultaneously?](#why-cant-libraries-just-support-v3-and-v4-simultaneously)